...
export const getPricesForVariant = (variant: any) => {
  ...
  if (!variant?.calculated_price?.calculated_amount_with_tax) {
    return {
      ...
      calculated_price_without_tax_number: variant.calculated_price.calculated_amount_without_tax,
  ...
  return {
    calculated_price_number: variant.calculated_price.calculated_amount_with_tax,
    calculated_price: convertToLocale({
