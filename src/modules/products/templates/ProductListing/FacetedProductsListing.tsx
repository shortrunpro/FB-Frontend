...
export const FacetedProductsListing = ({ category_name, initialQuery }: { category_name?: string, initialQuery?: string; }) => {
    ...
    <div className="min-h-[70vh]">
      ...
      <div className="gap-4 md:flex">
        <div className="hidden w-[280px] flex-shrink-0 md:block">
          <FacetedProductSidebar facets={facets} />
        </div>
