    ...
    <div className="flex w-full flex-col">
      ...
      >
        <Tabs.List className="font-medium text-brand">
          <Tabs.Trigger
            value="specs"
            className="data-[state=active]:shadow-elevation-card-rest rounded-sm border-transparent p-2 hover:bg-brand hover:text-white data-[state=active]:bg-brand data-[state=active]:text-white"
          >
            Specifications
          </Tabs.Trigger>
          {/* <Tabs.Trigger
            ...
            <Table className="px-4">
              <Table.Body className="flex flex-col">
                ...
                <Table.Row className="bg-white px-4 odd:bg-gray-100 [&_td:last-child]:w-[1%] [&_td:last-child]:whitespace-nowrap">
                  ...
                  <Table.Cell>{variant?.weight && variant?.weight.toFixed(2)} lbs</Table.Cell>
                </Table.Row>
              </Table.Body>
            </Table>
          </Tabs.Content>
