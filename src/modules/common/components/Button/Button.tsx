...
export function Button({
  ...
  const baseClasses =
    'button-text rounded-sm disabled:bg-disabled disabled:text-disabled dark:bg-action-tertiary dark:hover:bg-action-tertiary-hover dark:active:bg-action-tertiary-pressed dark:disabled:bg-disabled transition hover:shadow-lg hover:-translate-y-0.5 shadow-md transition-all duration-200 ease-in-out disabled:translate-y-0 active:translate-y-0';
