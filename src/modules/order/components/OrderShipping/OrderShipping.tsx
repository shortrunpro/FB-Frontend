...
const OrderShipping = ({ order }: ShippingDetailsProps) => {
  ...
  return (
    <div className="rounded-sm border p-4">
      <div>
        <Text className="txt-medium-plus text-ui-fg-base mb-1 font-bold">Shipping Address</Text>
      ...
      >
        <Text className="txt-medium-plus text-ui-fg-base mb-1 font-bold">Contact</Text>
      ...
      >
        ...
        <Text className="txt-medium text-ui-fg-subtle">
          ...
          {(order as any)?.shipping_methods[0]?.total ?? 0}
        </Text>
      </div>
      {/* <div className="mt-4">
